...
abstract class CommonObject
{
	...
	function printObjectLines($action, $seller, $buyer, $selected=0, $dateSelector=0)
	{
		...
		// ELITASOFT
		if ($conf->global->ELITASOFT_SHOW_PREVIOUS_QTY_INPUT && $action != 'editline' && $this->element=='commande') {
			print '<td class="linecolqty prevqty" align="right" width="50">'.$langs->trans('TransferedQty').'</td>';
		}
		// end ELITASOFT
