...
<tr <?php echo 'id="row-'.$line->id.'" '.$bcdd[$var]; ?>>
	...
	<?php
	// ELITASOFT
	if ($conf->global->ELITASOFT_SHOW_PREVIOUS_QTY_INPUT && $object->element==commande)
	{
	?>	
	<td align="right" class="linecolqty prevqty nowrap">
		<?php $coldisplay++; ?>
		<?php echo ElitaAjaxInplaceInputEdit('commandedet', 'transfered_qty', $line->id, $line->transfered_qty, true); ?>
	</td>
	<?php
	}
	// end ELITASOFT
