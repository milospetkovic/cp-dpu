...
require_once DOL_DOCUMENT_ROOT.'/elitasoft/class/elita.ordersupplier.class.php';
...
elseif (! empty($object->id))
{
	...
	*/
	...
	if ($action == 'editdate')
	{
		...
		$usehourmin=0;
		if (! empty($conf->global->SUPPLIER_ORDER_USE_HOUR_FOR_DELIVERY_DATE)) $usehourmin=1;
		$form->select_date($object->date_commande,'re_',$usehourmin,$usehourmin,'',"setdate");
	...
	else
	{
		...
		print $object->date_commande ? dol_print_date($object->date_commande, 'day') : '&nbsp;';
	}
	print "</td></tr>";
	// end ELitasoft
